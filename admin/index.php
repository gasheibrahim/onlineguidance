...
<!-- <header class="header">
<section class="flex">
   <a href="index.php" class="logo"> <img src="images/logo-1.png" alt="homepage" style="margin-top:-15px;margin-bottom:-15px" /></a>
   <nav class="navbar">
      ...
      <?php
        ...
        if (isset($_REQUEST['email'])) {
            ...
            if ($rows == 1) {
                ...
                window.location.href='http://localhost/onlineguidance/admin/dashboard.php';
                </script>");
            } else {
                echo ("<script LANGUAGE='JavaScript'>
                window.alert('Incorrect email or password');
                window.location.href='http://localhost/onlineguidance/admin/index.php';
                </script>");
                }
            } else {
        ?>
